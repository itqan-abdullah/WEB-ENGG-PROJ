...
<body>
    <div class="page-wrapper">
                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#" data-toggle="modal"><i class="icon-user"></i>Login</a>
                                    </li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
        ...
        <?php
           ...
           $sql = "SELECT co.order_id AS 'id',i.title AS 'title',i.price AS 'price',co.quantity AS 'quantity',co.status AS 'status',c.address AS 'address',c.phone AS 'phone'
           FROM customer c INNER JOIN c_order co USING(customer_id) 
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url("assets/images/page-header-bg.jpg")">
                <div class="container">
                    <h1 class="page-title">Order History<span>"'.$user.'"</span></h1>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
        ...
        if (mysqli_num_rows($result) > 0) {
            echo '<br/><table><th>Id</th><th>Title</th><th>Price</th><th>Quantity</th><th>Status</th><th>Address</th><th>Phone</th>';
            ...
            echo '<span style="font-size:17px;">No Orders Placed Yet!</>';
        }
        ?>
    </div><!-- End .row -->
    </div><!-- End .products -->
