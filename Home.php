                            ...
                            <div class="intro-slider intro-slider-1 owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{
                                ...
                                <div class="intro-slide">
                                    <figure class="slide-image">
                                        <picture>
                                            <source media="(max-width: 480px)" srcset="Men-Collection.jpg">
                                ...
                                <div class="intro-slide">
                                    <figure class="slide-image">
                                        <picture>
                                            <source media="(max-width: 480px)" srcset="Women-Collection.jpg">
                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="banner banner-display">
                                        ...
                                        <div class="banner-content">
                                            <span style="font-size:45px;" class="intro-title">Kids's<br>Collection</span>
                                            <!-- End .intro-title -->
                                            <br>
                                            <a href="Kids-Category.html" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Chill FULL SLEEVES T-SHIRTS-1.jpg" alt="Product image" class="product-image">
                                    <img src="Chill FULL SLEEVES T-SHIRTS-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Good Miami Full Sleeves T-Shirts-1.jpg" alt="Product image" class="product-image">
                                    <img src="Good Miami Full Sleeves T-Shirts-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Graffiti UNISEX HOODIE-1.jpg" alt="Product image" class="product-image">
                                    <img src="Graffiti UNISEX HOODIE-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                            </figure><!-- End .product-media -->
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Future UNISEX HOODIE-2.jpg" alt="Product image" class="product-image">
                                    <img src="Future UNISEX HOODIE-1.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Cookies Printed Graphic T-Shirt-1.jpg" alt="Product image" class="product-image">
                                    <img src="Cookies Printed Graphic T-Shirt-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="Phsyco Men Graphic T-Shirt-1.jpg" alt="Product image" class="product-image">
                                    <img src="Phsyco Men Graphic T-Shirt-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="ladies unstitched1front .jpg" alt="Product image" class="product-image">
                                    <img src="ladies unstitched1back.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="ladies jeans front.jpg" alt="Product image" class="product-image">
                                    <img src="ladies jeans back.jpg" alt="Product image" class="product-image-hover">
                                </a>
                ...
                <div class="tab-pane p-0 fade" id="trendy-decor-tab" role="tabpanel" aria-labelledby="trendy-decor-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="pkids1.webp" alt="Product image" class="product-image">
                                    <img src="pkids1b.webp" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-11 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="pkids3.webp" alt="Product image" class="product-image">
                                    <img src="pkids3b.webp" alt="Product image" class="product-image-hover">
                                </a>
                ...
                <div class="col-6 col-lg-4">
                    <div class="banner banner-display banner-link-anim">
                        ...
                        <div class="banner-content banner-content-center">
                            ...
                            <!-- End .banner-title -->
                            <a href="Men-Category.html" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->
                ...
                <div class="col-6 col-lg-4 order-lg-last">
                    <div class="banner banner-display banner-link-anim">
                        ...
                        <div class="banner-content banner-content-center">
                            ...
                            <!-- End .banner-title -->
                            <a href="Women-Category.html" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->
                </div><!-- End .col-sm-6 col-lg-3 -->
